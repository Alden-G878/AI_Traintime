...
# 
# Currently, the models are properly imported from hdf5 (.h5) files or the SaveModel
...
# No SaveModel file exists currently, so the SaveModel code is commented out, but will be kept for reference
#print('init')
#time1 = time.time()
