...
def cartpole(rNum, mRun, path): #example path: /Users/groverj/AdvInq/AI_Traintime/Current/models/human_input/save_run
...
for i in range(1,516):
	print("Epoch: " + str(i))
	cartpole(i, 10, "/home/jetson/advinq/AI_Traintime/Current/models/jetson_tf/run5_jetson/save_run")
#sys.stdout.close()